Пакет позволяет проделывать операции, над каждым листом файлов Excel, содержащихся в файлах папки, переданной как параметр при инициализации объекта класса.
